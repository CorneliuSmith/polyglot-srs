...
- **Definitions.** The top 200 were read by a reader of Hausa and
  **43 repaired** through `scripts/apply_gloss_overrides.py`; a second
  reader accepted or corrected every one it saw. Faults found: wrong sense 25, reaches a synonym 8, circular 5.
  ...
  was skipped.
- **Hints.** **24 drill hints** that gave away their answer — sitting
...
- **State.** 99% of the top 1,000 have a sentence the card can
  ...
  usable sentence, or a fragment drawn — 1% of the time.
...
**5 definitions rewritten** in the rank 201–1000 band. Each stated a
...
- `dubbai` was "plural of dubu" → "thousands - a large indefinite number of people or things (plural of dubu, a thousand)"
- `awaki` was "plural of akuya" → "goats - plural of akuya, a goat (f.)"
