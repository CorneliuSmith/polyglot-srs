...
The sweep above covered the top 500. Ranks 501-2000 added **63 rows, 35 fatal**, so the
course total is **83 repaired (46 fatal) through rank 2000**.
...
| rank | word | now reads |
| --- | --- | --- |
| 538 | `nuova` | new (feminine singular of nuovo): la macchina è nuova 'the car is new';  |
| 542 | `sicura` | sure, certain; safe (feminine singular of sicuro): sono sicura 'I'm sure |
| 612 | `mandato` | sent (past participle of mandare): chi ti ha mandato qui? 'who sent you  |
| 634 | `fu` | was (third-person singular passato remoto of essere): fu amore a prima v |
| 655 | `arrivato` | arrived (past participle of arrivare): non è ancora arrivato 'he hasn't  |
| 668 | `amica` | friend (f.), female friend (feminine of amico): sei la mia migliore amic |
...
- **Definitions.** The top 200 were read by a reader of Italian and
  **60 repaired** through `scripts/apply_gloss_overrides.py`; a second
  reader accepted or corrected every one it saw. Faults found: a part-of-speech label 35, wrong sense 12, reaches a synonym 10.
...
**216 definitions rewritten** in the rank 201–1000 band. Each stated a
...
- `avete` was "second-person plural present indicative of avere" → "you have (plural) — own or hold; also the auxiliary of the past, you have done (second-person plural present of avere)"
- `miei` was "masculine plural of mio" → "my, mine — with masculine plural nouns (masculine plural of mio)"
...
**Band 1001–2000, same day: 295 more.**
- `potevo` was "first-person singular imperfect indicative of potere" → "I could, I was able to; I was allowed to (first-person singular imperfect of potere)"
- `conosciuto` was "past participle of conoscere" → "known, familiar; met, having got to know someone (past participle of conoscere)"
