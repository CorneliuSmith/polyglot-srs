...
- **Definitions.** The top 200 were read by a reader of Portuguese and
  **86 repaired** through `scripts/apply_gloss_overrides.py`; a second
  reader accepted or corrected every one it saw. Faults found: a part-of-speech label 45, reaches a synonym 21, wrong sense 10.
  127 of the top 200 now carry a hand-written definition — a low
...
- **State.** 96% of the top 1,000 have a sentence the card can
  actually blank; 99% of drills carry an interlinear gloss;
  0 fail-level audit findings; a top-2,000 card is bad — no
  usable sentence, or a fragment drawn — 14% of the time.
...
**221 definitions rewritten** in the rank 201–1000 band. Each stated a
...
- `têm` was "third-person plural present indicative of ter" → "they have; you have (plural) — own or hold something; with que, have to (present of ter)"
- `aconteceu` was "third-person singular preterite indicative of acontecer" → "it happened, it occurred; it took place (third-person preterite of acontecer)"
