...
- **Definitions.** The top 200 were read by a reader of Dutch and
  **64 repaired** through `scripts/apply_gloss_overrides.py`; a second
  reader accepted or corrected every one it saw. Faults found: reaches a synonym 22, a part-of-speech label 18, not a definition 15.
  103 of the top 200 now carry a hand-written definition — a low
  count means the extracted glosses were already right, not that the band
  was skipped.
- **Hints.** **21 drill hints** that gave away their answer — sitting
...
- **State.** 99% of the top 1,000 have a sentence the card can
  ...
  usable sentence, or a fragment drawn — 9% of the time.
...
**81 definitions rewritten** in the rank 201–1000 band. Each stated a
...
- `kwam` was "singular past indicative of komen" → "came — I/you/he/she/it came (singular past of komen)"
- `deed` was "singular past indicative of doen" → "did — I/you/he/she/it did (singular past of doen)"
