...
- **Definitions.** The top 200 were read by a reader of Catalan and
  **75 repaired** through `scripts/apply_gloss_overrides.py`; a second
  reader accepted or corrected every one it saw. Faults found: a part-of-speech label 41, reaches a synonym 16, wrong sense 9.
  108 of the top 200 now carry a hand-written definition — a low
  count means the extracted glosses were already right, not that the band
  was skipped.
- **Hints.** **29 drill hints** that gave away their answer — sitting
...
- **State.** 88% of the top 1,000 have a sentence the card can
...
**229 definitions rewritten** in the rank 201–1000 band. Each stated a
...
- `tenia` was "first/third-person singular imperfect indicative of tenir" → "I had, he/she/it had; you had (formal) — owned or held something (imperfect of tenir)"
- `fas` was "plural of fa" → "you do, you make (second-person singular present of fer)"
