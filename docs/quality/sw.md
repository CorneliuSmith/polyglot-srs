...
- **Definitions.** The top 200 were read by a reader of Swahili and
  **83 repaired** through `scripts/apply_gloss_overrides.py`; a second
  reader accepted or corrected every one it saw. Faults found: not a definition 57, reaches a synonym 15, wrong sense 7.
  110 of the top 200 now carry a hand-written definition — a low
  count means the extracted glosses were already right, not that the band
  was skipped.
- **Hints.** **4 drill hints** that gave away their answer — sitting
...
**133 definitions rewritten** in the rank 201–1000 band. Each stated a
...
- `wafu` was "plural of mfu" → "the dead, dead people — plural of mfu (class 1/2)"
- `wazee` was "plural of mzee" → "elders, old people; also the senior men of a family, or parents, spoken of with respect — plural of mzee (class 1/2)"
