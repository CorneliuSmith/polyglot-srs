...
- **Definitions.** The top 200 were read by a reader of Hebrew and
  **14 repaired** through `scripts/apply_gloss_overrides.py`; a second
  reader accepted or corrected every one it saw. Faults found: reaches a synonym 14.
  34 of the top 200 now carry a hand-written definition — a low
  count means the extracted glosses were already right, not that the band
  was skipped.
- **Hints.** **1 drill hints** that gave away their answer — sitting
...
- **State.** 95% of the top 1,000 have a sentence the card can
  ...
  usable sentence, or a fragment drawn — 43% of the time.
