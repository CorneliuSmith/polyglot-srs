...
- **Definitions.** The top 200 were read by a reader of Jamaican Patois and
  **9 repaired** through `scripts/apply_gloss_overrides.py`; a second
  reader accepted or corrected every one it saw. Faults found: reaches a synonym 6, not a definition 3.
  10 of the top 200 now carry a hand-written definition — a low
  count means the extracted glosses were already right, not that the band
  was skipped.
- **Hints.** **36 drill hints** that gave away their answer — sitting
...
- **State.** 100% of the top 1,000 have a sentence the card can
  ...
  5 fail-level audit findings; a top-2,000 card is bad — no
  usable sentence, or a fragment drawn — 0% of the time.
