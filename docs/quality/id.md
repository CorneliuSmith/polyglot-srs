...
- **Definitions.** The top 200 were read by a reader of Indonesian and
  **31 repaired** through `scripts/apply_gloss_overrides.py`; a second
  reader accepted or corrected every one it saw. Faults found: reaches a synonym 29, wrong sense 2.
  40 of the top 200 now carry a hand-written definition — a low
...
- **State.** 91% of the top 1,000 have a sentence the card can
  ...
  usable sentence, or a fragment drawn — 32% of the time.
