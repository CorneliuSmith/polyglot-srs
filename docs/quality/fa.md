...
- **Definitions.** The top 200 were read by a reader of Persian and
  **30 repaired** through `scripts/apply_gloss_overrides.py`; a second
  reader accepted or corrected every one it saw. Faults found: reaches a synonym 29, wrong sense 1.
  47 of the top 200 now carry a hand-written definition — a low
...
- `کنند` was "third-person plural present subjunctive and present indicative form of کردن" → "they do; they make - third-person plural of کردن, bare as the subjunctive and with می for the present; it also carries compound verbs, as in they live or they examine"
- `گفته` was "past participle of گفتن" → "said, spoken - past participle of گفتن, building the perfect (has said) and the passive (was said); as a noun, a saying, a remark"
