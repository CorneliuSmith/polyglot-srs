...
- **Definitions.** The top 200 were read by a reader of Russian and
  **104 repaired** through `scripts/apply_gloss_overrides.py`; a second
  reader accepted or corrected every one it saw. Faults found: not a definition 64, reaches a synonym 23, a part-of-speech label 8.
  133 of the top 200 now carry a hand-written definition — a low
  count means the extracted glosses were already right, not that the band
  was skipped.
- **Hints.** **2 drill hints** that gave away their answer — sitting
  inside their own translation, or only the agreement feature the drill
  tests — rewritten through `scripts/apply_drill_hints.py`.
- **Headwords.** **1 removed** to `vocab_exclusions.tsv` (letters,
...
- **State.** 99% of the top 1,000 have a sentence the card can
...
**3 definitions rewritten** in the rank 201–1000 band. Each stated a
...
- `понимаю` was "first-person singular present indicative imperfective of понима́ть" → "I understand; I see what you mean, I follow - first-person singular present of понимать (impf.; pf. понять)"
- `извини` was "second-person singular imperative perfective of извини́ть" → "sorry; excuse me, forgive me - said to one person you address informally (imperative of извинить, pf.; impf. извинять)"
