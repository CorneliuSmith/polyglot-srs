...
The sweep above covered the top 500. Ranks 501-2000 added **13 rows, 7 fatal**, so the
course total is **22 repaired (10 fatal) through rank 2000**.
...
| rank | word | now reads |
| --- | --- | --- |
| 638 | `αυτού` | of this, of that — genitive singular of αυτός/αυτό, and so also 'his, it |
| 962 | `δυνάμεις` | strengths, forces — plural of η δύναμη, power/strength (Ο Τομ έχει πολλέ |
| 1232 | `μυστικά` | secrets — plural of το μυστικό (Όλοι έχουν μυστικά — everyone has secret |
| 1478 | `αστεία` | jokes — plural of το αστείο (Ο Τομ μας είπε μερικά αστεία — Tom told us  |
| 1659 | `ελεύθερο` | free — accusative masculine singular and neuter singular of ελεύθερος (π |
| 1767 | `ήλιο` | sun — accusative of ο ήλιος (Λατρεύω τον ήλιο — I love the sun; έχει ήλι |
...
- **Definitions.** The top 200 were read by a reader of Greek and
  **102 repaired** through `scripts/apply_gloss_overrides.py`; a second
  reader accepted or corrected every one it saw. Faults found: not a definition 63, reaches a synonym 20, wrong sense 14.
  134 of the top 200 now carry a hand-written definition — a low
  count means the extracted glosses were already right, not that the band
  was skipped.
- **Hints.** **55 drill hints** that gave away their answer — sitting
  inside their own translation, or only the agreement feature the drill
  tests — rewritten through `scripts/apply_drill_hints.py`.
- **Headwords.** **2 removed** to `vocab_exclusions.tsv` (letters,
...
**6 definitions rewritten** in the rank 201–1000 band. Each stated a
...
- `πήγαινε` was "third-person singular imperfect of πηγαίνω" → "he was going, she was going, it was going; it was going along, as in how things were going (imperfect of πηγαίνω); also go! as a command to one person"
- `σταμάτα` was "second-person singular present imperfective imperative of σταματάω" → "stop!; halt, quit doing that - a command to one person you address informally (imperative of σταματάω)"
