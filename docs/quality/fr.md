...
- **Definitions.** The top 200 were read by a reader of French and
  **53 repaired** through `scripts/apply_gloss_overrides.py`; a second
  reader accepted or corrected every one it saw. Faults found: not a definition 20, reaches a synonym 20, wrong sense 11.
  85 of the top 200 now carry a hand-written definition — a low
  count means the extracted glosses were already right, not that the band
  was skipped.
- **Hints.** **34 drill hints** that gave away their answer — sitting
...
- **State.** 96% of the top 1,000 have a sentence the card can
  ...
  usable sentence, or a fragment drawn — 8% of the time.
