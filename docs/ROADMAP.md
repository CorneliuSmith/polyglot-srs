...
Transliterations auto-generated by the shared el romanizer. **Remaining:** ro,
mi (queued), then fr/de/it/ca; en stays A1 (targets learners *from* other
languages, deepened on demand).
