...
- **Closing step, per language: the markdown pass over `explanation`**
  ...
  JSON so nothing waits on it. **Five courses done (7 Sep 2026)** — fr, es, it, pt, de: 124 of 216 explanations formatted and 164 content defects corrected, the largest a Spanish `-er`/`-ir` paradigm that stopped mid-run so four forms the course drills appeared nowhere on the card. **The tooling:**
