...
| **B — the panel** | endpoint + `ContentHealthPanel` + Deployment "Content" section + targets table; auth on `/api/health` | none | 3 | the owner can read a trend that was previously impossible |
