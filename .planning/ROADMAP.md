...
Plans:
- [x] 04-01-PLAN.md -- Backend API: extend get_due_cards with content JOIN, add validate-answer, learn, and dashboard endpoints
...
| 4. Core Review Experience | 3/5 | In Progress|  |
