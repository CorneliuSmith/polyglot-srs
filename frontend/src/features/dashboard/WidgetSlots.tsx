        ...
        return (
          <div key={level} className="flex flex-col gap-1 min-w-0">
            <span className="text-[10px] font-semibold text-gray-500">
              {level} <span className="font-normal text-gray-500">{pct}%</span>
            </span>
      ...
      {Array.from({ length: SLOT_COUNT }, (_, i) => {
        ...
        if (id) {
          ...
          return (
            ...
            >
              <h2 className="w-20 sm:w-24 shrink-0 text-[10px] uppercase tracking-wide text-gray-500 leading-tight">
                {t(LABEL_KEYS[id])}
              </h2>
            ...
            {pickerFor === i ? (
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 px-3 py-2 flex flex-wrap items-center gap-1.5">
                ...
                <button
                  ...
                  className="ms-auto px-2 py-1 text-[10px] text-gray-500 hover:text-gray-600"
                >
                  {t('common.cancel')}
                </button>
              </div>
              ...
              <button
                ...
                className="w-full h-12 rounded-2xl border-2 border-dashed border-gray-200 flex items-center justify-center gap-1.5 text-gray-500 hover:text-lang hover:border-lang/40 transition-colors"
              >
