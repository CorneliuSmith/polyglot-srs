...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-x-hidden">
      ...
      <div className={`${PAGE_WIDE} mx-auto px-4 py-8 space-y-6 pb-24 md:pb-8`}>
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            {/* Utility cluster, set apart from navigation: announcements
                and the tour are ABOUT the app, not places in it. Shared
                with the other three sections (components/HeaderUtilities);
                only Study auto-opens the tour — it is the landing page. */}
            <span aria-hidden className="hidden md:block h-4 w-px bg-gray-200" />
            <HeaderUtilities autoOpenTour />
        ...
        <div className="lg:grid lg:grid-cols-[minmax(0,1fr)_18rem] xl:grid-cols-[minmax(0,1fr)_22rem] lg:gap-6 lg:items-start">
        ...
        {/* iPhone-style widget slots (owner request): open spaces below the
            Learn/Review tiles where the learner pins full-width bar views
            of the progress charts they prefer. */}
