# Curriculum reference — Jamaican Patois (jam)
...
## A1
- Pronouns: mi, yu, im, wi, unu, dem — One form does it all — subject, object, and possessive
- The equative copula a: Mi a di tiicha — Say who or what someone IS
- The locative copula de: Im de a yaad — Say WHERE someone or something is
- Zero copula with adjectives: Di uman nais — With adjectives, there is no 'is' at all
- Bare verbs — no endings, ever — One verb form covers I/you/he and present/past
- Progressive a: Mi a ron — Say what is happening right now
- Plural with dem: di pikni dem — Make plurals without -s
...
- Completive don: Mi don nyam — Say something is finished — already done
- Possession with fi: a fi mi buk — Say whose it is
- Se after talk and know: Im tel mi se… — Report speech and thoughts
...
- Mek: let, make, and let's — Suggest, permit, and cause with one verb
