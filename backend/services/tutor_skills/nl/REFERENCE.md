...
## A1
- Word order: the verb comes second — Build your first sentences — one verb slot, position two
- De and het: the two genders — Every noun is a de-word or a het-word
- Subject pronouns: ik, jij, u, hij, zij… — Say who does what — with the polite u
- Zijn — present (ben, bent, is, zijn) — Say who or what someone is
- Hebben — present (heb, hebt, heeft) — Say what you have
- Present tense: stem, stem+t, infinitive — Conjugate any regular verb with three forms
- Plurals: -en and -s — More than one — and every plural is a de-word
- Negation: niet and geen — Two words for 'not' — and the choice is grammatical
- Questions: inversion and question words — Ask by flipping — no 'do' needed
...
- Modal verbs: kunnen, moeten, mogen, willen — Can, must, may, want — with the infinitive at the end
- Separable verbs: opstaan → ik sta op — The prefix breaks off and lands at the end
- Subclauses: the verb walks to the end — After omdat, dat, als — everything changes
- Future: gaan + infinitive, zullen — Plans with gaan, promises with zullen
- Comparative and superlative: -er, -st — Bigger and biggest — with dan, not als
...
- Reflexive verbs: zich vergissen, zich voelen — Verbs that point back at their subject
- The passive: worden and zijn — It is being done vs it is done
- Want vs omdat, dus and maar — Two 'becauses' with two word orders
...
- Double infinitives: heb kunnen doen — Perfect + modal = two infinitives at the end
